  ...
  return (
    <main className="notes naxatw-h-screen-nav naxatw-w-full naxatw-bg-white">
      <div className="naxatw-container naxatw-h-full naxatw-py-4">
        <FlexRow className="naxatw-gap-4 naxatw-h-full">
          <FlexColumn className="naxatw-w-full md:naxatw-w-1/3 naxatw-gap-2 naxatw-max-h-[calc(100vh-140px)] naxatw-overflow-auto">
            {data?.map((note: NoteItem) => (
              <button
                key={note.id}
                onClick={() => setActiveNote(note)}
                className={`naxatw-text-left naxatw-w-full naxatw-border naxatw-rounded-md naxatw-p-3 hover:naxatw-bg-gray-50 ${
                  activeNote?.id === note.id ? "naxatw-border-blue-500" : "naxatw-border-gray-200"
                }`}
              >
                <div className="naxatw-font-semibold">{note.title}</div>
          ...
          <FlexColumn className="naxatw-flex-1 naxatw-min-h-[60vh] naxatw-border naxatw-rounded-md naxatw-overflow-hidden">
            {!activeNote ? (
              <Flex className="naxatw-h-full naxatw-justify-center naxatw-items-center">
